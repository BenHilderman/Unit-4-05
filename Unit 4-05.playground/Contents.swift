...
// made by: Benjamin H
// made for: ICS3U
// This program calculates the volume of the given radius and height
...
class ViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        instructionLabel.text = "Enter the radius and height"
        ...
        enterButton.setTitle("Calculate", for: .normal)
        ...
        calculateButton.setTitle("Solve", for: .normal)
